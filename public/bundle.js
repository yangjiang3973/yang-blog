      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            ...
            console.log('updateEmail -> err', _context.t0); // showAlert('error', err.response.data.message);
